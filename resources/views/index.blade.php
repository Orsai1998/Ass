...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item">
                            <a class="nav-link waves-effect waves-dark" href="#"></a>
                        </li>
                    </ul>
                </div>
            </nav>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div>
                                        <h3 class="card-title m-b-5"><span class="lstick"></span>Amount of employees in each department </h3>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div>
                                        <h4 class="card-title"><span class="lstick"></span>Amount of employee in each position</h4></div>
                                </div>
                                <div class="table-responsive m-t-20">
                                    <div id="department" class="p-relative" style="height:360px;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <h4 class="card-title"><span class="lstick"></span>Max salary in each position</h4>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <h4 class="card-title"><span class="lstick"></span>Average salary of each positions</h4>
                                      
                                </div>
                                <div id="avgsalary" class="p-relative" style="height:360px;"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    // ============================================================== 
     new Chartist.Bar('#sales-overview2', {
        labels: [@foreach($countEmp as $key)
        '{{$key->dept_name}}',
        @endforeach]
        , series: [
          {meta:"Amount", data: [@foreach($countEmp as $key)
        {{$key->amount}},
        @endforeach ]}
      ]
    }, {
        ...
        $(function(){
       var chart= new Chartist.Pie('#department', {
  series: [@foreach($countTitle as $key)
        {{$key->amountInEach}},
        @endforeach ],
  labels: [@foreach($countTitle as $key)
        '{{$key->title}}',
        @endforeach]
}, {
  donut: true,
...
chart.on('created', function() {
  ...
  window.__anim21278907124 = setTimeout(chart.update.bind(chart), 10000);
        ...
        $(function(){
            new Chartist.Bar('#salary', {
  labels: [@foreach($countMax as $key)
        '{{$key->title}}',
        @endforeach],
  series: [@foreach($countMax as $key)
        {{$key->max}},
        @endforeach ]
}, {
  ...
  , showArea: true
        ...
        $(function(){
            new Chartist.Bar('#avgsalary', {
  labels: [@foreach($countMax as $key)
        '{{$key->title}}',
        @endforeach],
  series: [@foreach($countAVG as $key)
        {{$key->avg}},
        @endforeach ]
}, {
  distributeSeries: true
