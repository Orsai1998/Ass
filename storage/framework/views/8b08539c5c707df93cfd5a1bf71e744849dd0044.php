...
<body class="fix-header card-no-border fix-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="/showInfo" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Employees</span></a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-7">
                              ...
                              <h4 class="card-title">Personal information Table</h4>
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $perInf; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($key->emp_no); ?></td>
                        ...
                        <div class="card">
                            <div class="card-body">
                              <h4 class="card-title">Position information Table</h4>
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ked): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($ked->title); ?></td>
                                                <td><?php echo e($ked->from_date); ?></td>
                                                <td><?php echo e($ked->to_date); ?></td>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                                    </table>
                        ...
                        <div class="card">
                            <div class="card-body">
                                 <h4 class="card-title">Salary information Table</h4>
    ...
    // ============================================================== 
     new Chartist.Line('#salary', {
        labels: [
         <?php $__currentLoopData = $salary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        '<?php echo e($key->from_date); ?>',
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ]
        , series: [
          {meta:"Earning ($)", data: [<?php $__currentLoopData = $salary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <?php echo e($key->salary); ?>,
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>]}
      ]
    }, {
        low: 0
